 ...
 */
abstract contract IRFTFTEnumerable is IRFTFT {
	/**
	 * @notice Returns total token supply of RFT Fungible Token (ERC-20 compatible)
	 */
	function totalSupply() virtual public view returns (uint256 _totalSupply);
	 ...
	 */
	function getNFT() virtual public view returns (address _nftAddress, uint256 _tokenId);
}